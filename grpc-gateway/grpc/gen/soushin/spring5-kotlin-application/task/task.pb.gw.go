...
func request_TaskService_FindTaskService_0(ctx context.Context, marshaler runtime.Marshaler, client TaskServiceClient, req *http.Request, pathParams map[string]string) (TaskService_FindTaskServiceClient, runtime.ServerMetadata, error) {
	var protoReq FindTaskInbound
	var metadata runtime.ServerMetadata
	...
	stream, err := client.FindTaskService(ctx, &protoReq)
	if err != nil {
...
func RegisterTaskServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TaskServiceClient) error {
	...
	mux.Handle("POST", pattern_TaskService_GetTaskService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle("POST", pattern_TaskService_FindTaskService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(ctx)
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_TaskService_FindTaskService_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_TaskService_FindTaskService_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_TaskService_GetTaskService_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"grpcgateway", "task"}, ""))

	pattern_TaskService_FindTaskService_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"grpcgateway", "tasks"}, ""))
)

var (
	forward_TaskService_GetTaskService_0 = runtime.ForwardResponseMessage

	forward_TaskService_FindTaskService_0 = runtime.ForwardResponseStream
)
